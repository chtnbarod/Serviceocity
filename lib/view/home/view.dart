...
import 'package:serviceocity/view/home/widget/grid_sub_category.dart';
import 'package:serviceocity/view/home/widget/location.dart';
                        ...
                        Stack(
                          ...
                          children: [
                            Container(
                              ...
                              child: CommonImage(
                                imageUrl: "${ApiProvider.url}/${logic.topImage ??
                                    ""}",
                              ),
                            ),
                            Positioned(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CommonImage(
                                ...
                                imageUrl: "${ApiProvider.url}/${logic.middleImage ??
                                    ""}",
                              ),
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return GridCategory(
                                    categoryModel: logic.categories[index],
                                    onTap: () {
                                ...
                                itemBuilder: (context, index) {
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      if(logic.featureList[index].featureServices
                                          ?.isNotEmpty ?? false)
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment
                                              .start,
                                      ...
                                      if(logic.featureList[index].featureCats
                                          ?.isNotEmpty ?? false)
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment
                                              .start,
                                          children: [
                                            ...
                                            for(int i = 0; i <
                                                (logic.featureList[index].featureCats
                                                    ?.length ?? 0); i++)...[
                                              Column(
                                                children: [
                                                  Stack(
